...
@Composable
fun LearnWelcomeScreen(onLetsGo: () -> Unit) {
    Column(
        modifier = Modifier
            .fillMaxSize()
            .padding(24.dp)
        ...
        Image(
                painter = painterResource(id = R.drawable.img), // Replace 'my_image' with your image file name
        ...
        Column(horizontalAlignment = Alignment.CenterHorizontally) {
            Text(text = "Learn", style = MaterialTheme.typography.headlineMedium)
            Spacer(Modifier.height(12.dp))
            Text(
