...
)
{
    Column(
        ...
        Column(horizontalAlignment = Alignment.CenterHorizontally) {
            ...
            Image(
                painter = painterResource(id = R.drawable.doctor_option_img), // Replace 'my_image' with your image file name
        ...
        Button(
            ...
            colors = ButtonDefaults.buttonColors(
                containerColor = colorResource(com.project.common_utils.R.color.green), // Orange background
        ...
        OrangeButton(onClick = onAppointment, "Make an appointment")
    }
}